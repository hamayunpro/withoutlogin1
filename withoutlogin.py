...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mHamayun Khanâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
💙💙💙💙💙💙💙💙💙💙💙💙💙
 ...
 \033[1;96m          WHATSAPP NO +923319258250
"""
...
\033[1;91m db   db  .d8b.  .88b  d88.  .d8b.  db    db db    db d8b   db 
\033[1;91m 88   88 d8' `8b 88'YbdP`88 d8' `8b `8b  d8' 88    88 888o  88 
 \033[1;91m88ooo88 88ooo88 88  88  88 88ooo88  `8bd8'  88    88 88V8o 88 
 \033[1;91m88~~~88 88~~~88 88  88  88 88~~~88    88    88    88 88 V8o88 
\033[1;91m 88   88 88   88 88  88  88 88   88    88    88b  d88 88  V888 
 \033[1;91mYP   YP YP   YP YP  YP  YP YP   YP    YP    ~Y8888P' VP   V8P                                                                                                                              
...
while (loop == 'true'):
    ...
    if (passcode == CorrectPasscode):
            print """
            \033[1;92mWelcome to All friends
                  """
            loop = 'false'
    else:
...
def login():
    ...
    time.sleep(0.05)
    print '\x1b[1;95m[0]\033[1;92m Exit (Quit )'
    pilih_login()
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[1] Hamayun Start Cracking'
    time.sleep(0.05)
...
def action():
    ...
    jalan ("\033[1;95mTotal 5 password will clone 11 digit , last 7 digit, pakistan, 000786, 786786 password Start Cracking...")
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;91m[1] RH Hamayun Start Cracking'
    time.sleep(0.05)
    print '\x1b[1;92m[0] \033[1;93m Back'
    time.sleep(0.05)
    action()
